...
local TestTab = Page:CreateSection({
    Name = "Tab Name", -- à¸Šà¸·à¹ˆà¸­
    Side = "Left" -- à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡ Left/Right
})

TestTab:AddToggle({
    Name = "Toggle",
	Value = _G.ConfigToggle, -- à¸›à¸£à¸±à¸šà¸„à¹ˆà¸²Toggle true/false or Config
...
TestTab:AddDropdown({
	Name = "Nomal Drop",
	Value = "", -- à¸„à¹ˆà¸²à¸—à¸µà¹ˆà¸ˆà¸°à¹ƒà¸«à¹‰à¸¡à¸±à¸™à¹€à¸¥à¸·à¸­à¸
	List = ItemList,
	Callback = function(value)
...
TestTab:AddSlider({
	Name = "Slider",
	Value = 25, -- à¸„à¹ˆà¸²à¸—à¸µà¹ˆà¹ƒà¸«à¹‰à¹€à¸¥à¸·à¸­à¸
	Min = 1, -- à¸™à¹‰à¸­à¸¢à¸ªà¸¸à¸”
	Max = 100, -- à¸¡à¸²à¸à¸ªà¸¸à¸”
	Format = "TestSlider : %s%%",
	Callback = function(value)
